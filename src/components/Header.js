...
const Header = ({ onCategorySearch }) => {
  ...
  return (
    <div className="bg-[#1d1717] p-6 flex items-center justify-evenly border-2 border-yellow-500">
      <div className=" bg-[url('https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExYXZrdDRyMm5jODVlM2dsdWNiaTVnampncDU2eW4zamMycDB3dXIzYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/04Y7m4gkurv2XjOzxv/giphy.gif')] w-auto h-auto p-12 rounded-3xl bg-cover basis-1/12 rounded-md border-2 border-yellow-500" />
